...
public class buscar_productos_nota_pedido_interno extends javax.swing.JFrame {
    ...
    public static void BuscarProducto() {
        try {
            ...
            ps = conexion.prepareStatement("select id_producto, nombre, precio, stock from productos where id_comercio = '" + Metodos.id_comercio + "' and (borrado_int != '1' or borrado_int is null) and nombre like '%" + Pedido_a_proveedores.jTextField_buscar_producto.getText() + "%'");
            rs = ps.executeQuery();
            rsm = rs.getMetaData();
