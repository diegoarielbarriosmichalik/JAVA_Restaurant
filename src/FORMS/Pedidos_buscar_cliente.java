...
public class Pedidos_buscar_cliente extends javax.swing.JFrame {

    public static int formulario;

    public Pedidos_buscar_cliente() {
        initComponents();
    ...
    private void jT_BuscarKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jT_BuscarKeyReleased
        Metodos.Pedidos_Buscar_cliente_cargar_lista();
...
//                ResultSet RS_Productos = ST_Productos.executeQuery("SELECT * FROM cliente where nombre like '%" + jT_Buscar.getText() + "%'"
...
//        Ventas.form_cliente = 0;
    ...
    private void jTable_clientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_clientesMouseClicked
        Metodos.Pedidos_Cliente_editar_cargar_datos();
        this.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pedidos_buscar_cliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
