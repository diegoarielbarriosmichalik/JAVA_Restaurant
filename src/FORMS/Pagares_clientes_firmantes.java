...
public class Pagares_clientes_firmantes extends javax.swing.JFrame {

    public Pagares_clientes_firmantes() {
        initComponents();
        this.setLocationRelativeTo(null);
        this.setTitle("Clientes");
        setIconImage(new ImageIcon(getClass().getResource("/icon.png")).getImage());
        
         Metodos.Pagares_clientes_firmantes_buscar();
    }
    ...
    private void initComponents() {
        ...
        if (jTable_clientes.getColumnModel().getColumnCount() > 0) {
            ...
            jTable_clientes.getColumnModel().getColumn(1).setPreferredWidth(400);
        }
    ...
    private void jTable_clientesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable_clientesMouseClicked
      Metodos.Pagares_clientes_firmantes_selected_cliente();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pagares_clientes_firmantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
