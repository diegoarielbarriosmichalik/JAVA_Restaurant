...
public class Pedido_a_proveedores extends javax.swing.JFrame {
...
//        FORMS.buscar_productos_nota_pedido_interno.BuscarProducto();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pedido_a_proveedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Pedido_a_proveedores().setVisible(true);
            }
        });
    }
